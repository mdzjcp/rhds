#et CRAN repository to Posit Package Manager with pre-built binaries from a specific date
options(repos = c(CRAN = sprintf("https://packagemanager.posit.co/cran/2026-01-29/bin/linux/noble-%s/%s", R.version["arch"], substr(getRversion(), 1, 3))))
